<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-4 sm:flex sm:items-center sm:ml-6">
                <x-buttons.secondary download class="inline-flex" wire:click="downloadGenLink">
                    GenLink
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-navbars.responsive-nav-link class="inline-flex cursor-pointer" wire:click="downloadGenLink">
                GenLink
                <x-icons class="ml-2" icon="download" />
