...
class MapHashSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $maps = [
            ...
            // FFA 3
            'Conflict in the Mediterranean [WBC2021]' => ['B3ACCD6B', '284454', 'ffa/3', GameType::FREE_FOR_ALL_THREE],
            'Radiation Ultima [WBC2021]' => ['B3783736', '218190', 'ffa/3', GameType::FREE_FOR_ALL_THREE],
            ...
            'Naval Base Mabuhay [WBC2022]' => ['91147656', '516977', 'ffa/4', GameType::FREE_FOR_ALL_FOUR],
            'Tournament Spaceship [WBC2022]' => ['4F648EBB', '247142', 'ffa/4', GameType::FREE_FOR_ALL_FOUR],
            '[RANK] Bursting Asunder ZH v1' => ['541EBFB3', '247969', 'ffa/4', GameType::FREE_FOR_ALL_FOUR],
            ...
            // FFA 5
            'Allstars v3' => ['B076BC87', '321471', 'ffa/5', GameType::FREE_FOR_ALL_FIVE],
            ...
            'Sylt v5' => ['9E1C2CB9', '465291', 'ffa/5', GameType::FREE_FOR_ALL_FIVE],
            // 'taal lake final' => ['', '', 'ffa/5', GameType::FREE_FOR_ALL_FIVE],
            // 'Volcano Rush v3 [WBC2020]' => ['', '', 'ffa/5', GameType::FREE_FOR_ALL_FIVE],

            // FFA 6
            'Armored Fury ZH v2' => ['85C78960', '178408', 'ffa/6', GameType::FREE_FOR_ALL_SIX],
            ...
            '[RANK] Glacier 6 ZH v1' => ['B4B8C089', '372866', 'ffa/6', GameType::FREE_FOR_ALL_SIX],
            // '[RANK] Medieval Era ZH v1' => ['', '', 'ffa/6', GameType::FREE_FOR_ALL_SIX],
            '[RANK] Pagasa Fortress ZH v1' => ['D32081D0', '392831', 'ffa/6', GameType::FREE_FOR_ALL_SIX],
            '[RANK] Taiga Terror ZH v1' => ['738DA4FE', '338049', 'ffa/6', GameType::FREE_FOR_ALL_SIX],
            'Volcano Revenge v2' => ['50633B5', '329245', 'ffa/6', GameType::FREE_FOR_ALL_SIX],
            ...
            'Ancient Keep Bal [WBC2021]' => ['85591246', '422733', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            "Fergi's Revenge v2" => ['CCF07726', '604841', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            'Flower Oases' => ['CF04CE00', '382367', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            // 'himalaya (tk edit)' => ['', '', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            // 'Outpost 7 v2' => ['', '', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            'Purple Hearts [WBC2021]' => ['ABAA254C', '286530', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            'Storming Harvest v2 [WBC2021]' => ['A2CD1D94', '436891', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            'Swamp Assault v3 [WBC2021]' => ['D0EE6DF9', '375677', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],
            'Twenty4Seven [WBC2021]' => ['24DA6978', '632272', 'ffa/7', GameType::FREE_FOR_ALL_SEVEN],

            // FFA 8
            // 'Defcon 51' => ['', '', 'ffa/8', GameType::FREE_FOR_ALL_EIGHT],
            // 'Defcon 51 Winter' => ['', '', 'ffa/8', GameType::FREE_FOR_ALL_EIGHT],
            'Forgotten Valley [WBC2022]' => ['B7867297', '711327', 'ffa/8', GameType::FREE_FOR_ALL_EIGHT],
            ...
            '[RANK] Muddy Madness ZH v1' => ['84600A43', '505815', 'ffa/8', GameType::FREE_FOR_ALL_EIGHT],
            '[RANK] Wastelands Dust ZH v1' => ['423D1A83', '335266', 'ffa/8', GameType::FREE_FOR_ALL_EIGHT],
            'Thy Kingdom Lagoon [WBC2022]' => ['30556916', '509356', 'ffa/8', GameType::FREE_FOR_ALL_EIGHT],
